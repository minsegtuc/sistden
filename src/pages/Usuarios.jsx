        ...
        <div className='flex flex-col md:h-heightfull px-8 pt-8'>
            ...
            <div className='md:h-1/4 w-full flex flex-col items-center md:flex-row md:justify-between py-8 md:gap-0 gap-4'>
                ...
                <div className='md:w-2/5 flex justify-around items-center gap-20 md:gap-0'>
                    <NavLink to={'/usuarios/nuevo'} className='md:w-32 h-12 w-12 text-white md:rounded-md rounded-full text-sm md:px-4 md:py-1 px-2 bg-[#2ca900] flex flex-row items-center'>
                        <BsPlusCircleFill className='text-4xl' />
                        <span className='md:flex hidden text-center'>Nuevo usuario</span>
                    </NavLink>
                    <NavLink to={'/usuarios/modificar'} className='md:w-32 h-12 w-12 text-white md:rounded-md rounded-full text-sm md:px-4 md:py-1 px-2 bg-[#002649] flex flex-row items-center'>
                        <BiSolidEdit className='text-4xl' />
                        <span className='md:block text-center hidden'>Modificar usuario</span>
                    </NavLink>
                    <NavLink to={'/usuarios/eliminar'} className='md:w-32 h-12 w-12 text-white md:rounded-md rounded-full text-sm md:px-4 md:py-1 px-2 bg-[#f60021] flex flex-row items-center' disabled>
